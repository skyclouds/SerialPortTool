 ...
 * of {@link #checkNotNull(Object)} is appropriate to the situation. (The same
 * goes for the message-accepting overloads.)
 * <p>
...
public final class Preconditions {
     ...
     *                             will be appended to the formatted message in
     *                             square braces. Unmatched placeholders will be
     *                             left as-is.
     ...
     *
     * @param template a string containing 0 or more {@code %s} placeholders. null
     *                 is treated as "null".
