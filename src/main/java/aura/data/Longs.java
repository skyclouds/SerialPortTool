...
public final class Longs {
     ...
     * 0x1213141516171819L} would yield the byte array
     ...
     * the first 8 bytes of {@code bytes}; equivalent to
    ...
    /*
     * Moving asciiDigits into this static holder class lets ProGuard eliminate and
     * inline the Longs class.
     */
    ...
    /**
     * Returns a comparator that compares two {@code long} arrays <a href=
     ...
     * Collections.reverse(Longs.asList(array))}, but is likely to be more
     * efficient.
     *
     * @since 23.1
     */
     ...
     * The ASCII character {@code '-'} (<code>'&#92;u002D'</code>) is recognized as
     * the minus sign.
     *
     * <p>
     ...
     * <p>
     * Note that strings prefixed with ASCII {@code '+'} are rejected, even under
     * JDK 7, despite the change to {@link Long#parseLong(String, int)} for that
     * version.
     *
