...
public final class Shorts {
   ...
   * array; equivalent to {@code ByteBuffer.allocate(2).putShort(value).array()}.
   ...
   * different types), use a shared {@link java.nio.ByteBuffer} instance to get a
   * growable buffer.
   */
   ...
   * the first 2 bytes of {@code bytes}; equivalent to
   ...
   * {@code join("-", (short) 1, (short) 2, (short) 3)} returns the string {@code
   * "1-2-3"}.
   *
  ...
  /**
   * Returns a comparator that compares two {@code short} arrays <a href=
   * "http://en.wikipedia.org/wiki/Lexicographical_order">lexicographically</a>.
   * That is, it compares, using {@link #compare(short, short)}), the first pair
   ...
   * Collections.reverse(Shorts.asList(array))}, but is likely to be more
   * efficient.
   *
   * @since 23.1
   */
   ...
   * Collections.reverse(Shorts.asList(array).subList(fromIndex, toIndex))}, but
