...
public final class Floats {
   ...
   * GWT. In the previous example, it returns the string {@code "1-2-3"}.
   *
   ...
   *
   * <p>
   * Note that this method uses the total order imposed by {@link Float#compare},
   ...
   *
   * <p>
   * This implementation is likely to be faster than {@code Float.parseFloat} if
