...
public final class Booleans {
     ...
     * <p>
     * <p>
     * <b>Note:</b> consider representing the array as a {@link java.util.BitSet}
     * instead, replacing {@code Booleans.contains(array, true)} with
     * {@code !bitSet.isEmpty()} and {@code
     ...
     * <p>
     * <b>Note:</b> consider representing the array as a {@link java.util.BitSet}
     * instead, and using {@link java.util.BitSet#nextSetBit(int)} or
    ...
    /**
     * Returns a comparator that compares two {@code boolean} arrays <a href=
     * "http://en.wikipedia.org/wiki/Lexicographical_order">lexicographically</a>.
     * That is, it compares, using {@link #compare(boolean, boolean)}), the first
     * pair of values that follow any common prefix, or when one array is a prefix
     * of the other, treats the shorter array as the lesser. For example,
     ...
     * Collections.reverse(Booleans.asList(array))}, but is likely to be more
     * efficient.
     *
     * @since 23.1
     */
     ...
     * Collections.reverse(Booleans.asList(array).subList(fromIndex, toIndex))}, but
