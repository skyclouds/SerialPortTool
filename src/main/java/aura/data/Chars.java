...
public final class Chars {
     ...
     * array; equivalent to {@code ByteBuffer.allocate(2).putChar(value).array()}.
    ...
    /**
     * Returns the {@code char} value whose big-endian representation is stored in
     ...
     * Collections.reverse(Chars.asList(array))}, but is likely to be more
     * efficient.
     *
     * @since 23.1
     */
